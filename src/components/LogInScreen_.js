    ...
    return (
          ...
          <div className="py-5 text-center" style={{backgroundImage: 'url("https://static.pingendo.com/cover-bubble-dark.svg")', backgroundSize: 'cover', position: 'fixed', bottom: 0, left: 0, right: 0, top: 0}}>
            <div className="container" style={{paddingTop:"300px"}}>
                  ...
                  <h3 style={{textAlign:"center"}}><a style={{color:"#fff", padding:"10px", backgroundColor:"#307bff", width:"50px", borderRadius:"5px"}} href={`https://blooming-forest-68248.herokuapp.com/sessions/login?sessionId=${this.state.sessionID}&callback=https://reactjsissuetracker.herokuapp.com/`}>Login</a></h3>
            </div>
          </div>
